      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              An open source example project for building a skills directory.
            </p>
            <a
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a
                  href="https://github.com/flinstonedev/lmskills/issues"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-muted-foreground hover:text-foreground"
                >
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a
                  href="https://github.com/flinstonedev/lmskills/blob/main/LICENSE"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-muted-foreground hover:text-foreground"
                >
        ...
        <div className="mt-8 pt-8 border-t text-center text-sm text-muted-foreground">
          <p>
            ...
            <a
              href="https://github.com/flinstonedev"
              target="_blank"
              rel="noopener noreferrer"
